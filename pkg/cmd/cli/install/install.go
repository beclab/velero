...
func (o *InstallOptions) BindFlags(flags *pflag.FlagSet) {
	...
	flags.IntVar(&o.Retry, "retry", 30, "Set the retry count for resource creation. Optional.")
	flags.IntVar(&o.Delay, "delay", 5, "Set the retry interval, unit: seconds. Optional.")
